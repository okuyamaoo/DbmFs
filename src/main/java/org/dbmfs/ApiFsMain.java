 ...
 */
public class ApiFsMain {

    private static final Log log = LogFactory.getLog(ApiFsMain.class);
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            ApiFilesystem dbfs = new ApiFilesystem(dbmfsParams.get("dbdriver"), dbmfsParams.get("dburl"), dbmfsParams.get("dbuser"), dbmfsParams.get("dbpass"), dbmfsParams.get("readonly"), bindQueryFolder);
